...
const Header = () => {
    ...
    return (
        <div>
            <header className={header? ' fixed max-w-screen-2xl w-full mx-auto  shadow-xl px-8 py-6 bg-white z-10':'px-8 md:py-12 py-6 bg-transparent fixed max-w-screen-2xl w-full mx-auto z-10'}>
