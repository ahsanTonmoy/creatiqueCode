...
import shape87 from '@/assects/image/shape/shape_87.svg'
            ...
            <div className={`${bgColor} relative `}>
                <div className="p-4 md:p-10 lg:p-20">
                    ...
                    <div className={`${xFector}`}>
                        <Image src={shapeL} alt="" className="lazy-img shapes shape-four absolute left-0 bottom-[3%] z-1" />
                        <Image src={shapeR} alt="" className="lazy-img shapes shape-five absolute right-0 top-[6%] z-1"></Image>
                    </div>
                    <div>
                        {content}
                    </div>
