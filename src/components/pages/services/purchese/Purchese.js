                        ...
                        <div className="flex flex-wrap mx-[-12px]">
                            <div className="xl:w-8/12  lg:w-10/12  m-auto text-center w-full flex-[0_0_auto] px-[12px] max-w-full">&gt;
                                <div className="title-style-one text-5xl leading-tight">
                                    <h2 className="main-title font-bold text-black !m-0">Ready to take plan? It’s just a matter of <span className=" inline-block relative z-[1] before:content-[''] before:absolute before:w-[98%] before:h-3 before:z-[-1] before:left-1 before:bottom-2.5 before:bg-[rgba(255,139,37,0.4)]">one clike</span></h2>
                                </div>
                                <p className="text-[24px] 2xl:text-[22px] lg:text-[19px] md:text-[19px] sm:text-[19px] xsm:text-[19px] leading-[1.67em]  text-black  pt-10  pb-[35px]  lg:pt-[30px] md:pt-[30px] sm:pt-[30px] xsm:pt-[30px]  lg:pb-5 wow fadeInUp" data-wow-delay="0.1s" >Try it risk free — we don’t charge cancellation fees.</p>
